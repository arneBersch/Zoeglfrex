...
int main(int argc, char *argv[]) {
    ...
    if (fileExists) {
        ...
        const QStringList createTableQueries = {
            ...
            "CREATE TABLE positions (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', pan REAL DEFAULT 0 NOT NULL, tilt REAL DEFAULT 0 NOT NULL, zoom REAL DEFAULT 15 NOT NULL, PRIMARY KEY (key))",
