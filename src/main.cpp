...
int main(int argc, char *argv[]) {
    ...
    const QStringList createTableQueries = {
        ...
        "CREATE TABLE IF NOT EXISTS colors (key INTEGER, id INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '' NOT NULL, hue REAL DEFAULT 0 NOT NULL, saturation REAL DEFAULT 0 NOT NULL, quality REAL DEFAULT 100 NOT NULL, PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS positions (key INTEGER, id INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '' NOT NULL, pan REAL DEFAULT 0 NOT NULL, tilt REAL DEFAULT 0 NOT NULL, zoom REAL DEFAULT 15 NOT NULL, PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS effects (key INTEGER, id INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '' NOT NULL, steps INTEGER DEFAULT 2 NOT NULL, PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS cuelists (key INTEGER, id INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '' NOT NULL, priority INTEGER DEFAULT 100 NOT NULL, movewhiledark INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (key))",
