...
int main(int argc, char *argv[]) {
    ...
    if (fileExists) {
        ...
        queries.append(createItemListAttributeTable("group_fixtures", "groups", "fixtures"));
        queries.append("CREATE TABLE raws (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', movewhiledark INTEGER DEFAULT 0 NOT NULL, fade INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (key))");
        queries.append(createIntegerSpecificNumberAttribute("raw_channel_values", "raws", "INTEGER"));
        queries.append(createItemAndIntegerSpecificNumberAttribute("raw_model_channel_values", "raws", "models", "INTEGER"));
        queries.append(createItemAndIntegerSpecificNumberAttribute("raw_fixture_channel_values", "raws", "fixtures", "INTEGER"));
        queries.append("CREATE TABLE intensities (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', dimmer REAL DEFAULT 0 NOT NULL, PRIMARY KEY (key))");
        queries.append(createItemSpecificNumberAttributeTable("intensity_model_dimmer", "intensities", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("intensity_fixture_dimmer", "intensities", "fixtures", "REAL"));
        queries.append(createItemListAttributeTable("intensity_raws", "intensities", "raws"));
        queries.append("CREATE TABLE colors (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', hue REAL DEFAULT 0 NOT NULL, saturation REAL DEFAULT 0 NOT NULL, quality REAL DEFAULT 100 NOT NULL, PRIMARY KEY (key))");
        queries.append(createItemSpecificNumberAttributeTable("color_model_hue", "colors", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("color_fixture_hue", "colors", "fixtures", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("color_model_saturation", "colors", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("color_fixture_saturation", "colors", "fixtures", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("color_model_quality", "colors", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("color_fixture_quality", "colors", "fixtures", "REAL"));
        queries.append(createItemListAttributeTable("color_raws", "colors", "raws"));
        queries.append("CREATE TABLE positions (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', pan REAL DEFAULT 0 NOT NULL, tilt REAL DEFAULT 0 NOT NULL, zoom REAL DEFAULT 15 NOT NULL, focus REAL DEFAULT 0 NOT NULL, PRIMARY KEY (key))");
        queries.append(createItemSpecificNumberAttributeTable("position_model_pan", "positions", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("position_fixture_pan", "positions", "fixtures", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("position_model_tilt", "positions", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("position_fixture_tilt", "positions", "fixtures", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("position_model_zoom", "positions", "models", "REAL"));
        queries.append(createItemSpecificNumberAttributeTable("position_fixture_zoom", "positions", "fixtures", "REAL"));
        ...
        queries.append("CREATE TABLE effects (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, label TEXT DEFAULT '', steps INTEGER DEFAULT 2 NOT NULL, hold REAL DEFAULT 0 NOT NULL, fade REAL DEFAULT 0 NOT NULL, phase REAL DEFAULT 0 NOT NULL, sinefade INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (key))");
        ...
        queries.append(createIntegerSpecificItemListAttribute("effect_step_raws", "effects", "raws"));
        queries.append(createIntegerSpecificNumberAttribute("effect_step_hold", "effects", "REAL"));
        ...
        queries.append("CREATE VIEW currentfixtures AS SELECT fixtures.* FROM fixtures, currentitems, currentgroup_fixtures WHERE currentitems.fixture_key = fixtures.key OR (currentitems.fixture_key IS NULL AND currentgroup_fixtures.key = fixtures.key)");
