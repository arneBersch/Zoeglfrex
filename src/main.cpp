...
int main(int argc, char *argv[]) {
    ...
    if (fileExists) {
        ...
        const QStringList createTableQueries = {
            ...
            "CREATE TABLE raw_channels (raw_key INTEGER REFERENCES raws (key) ON DELETE CASCADE NOT NULL, channel INTEGER NOT NULL, value INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (raw_key, channel))",
            "CREATE TABLE raw_model_channels (raw_key INTEGER REFERENCES raws (key) ON DELETE CASCADE NOT NULL, model_key INTEGER REFERENCES models (key) ON DELETE CASCADE NOT NULL, channel INTEGER NOT NULL, value INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (raw_key, model_key, channel))",
            "CREATE TABLE raw_fixture_channels (raw_key INTEGER REFERENCES raws (key) ON DELETE CASCADE NOT NULL, fixture_key INTEGER REFERENCES fixtures (key) ON DELETE CASCADE NOT NULL, channel INTEGER NOT NULL, value INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (raw_key, fixture_key, channel))",
            ...
            "CREATE TABLE effect_step_hold (effect_key INTEGER REFERENCES effects (key) ON DELETE CASCADE NOT NULL, step INTEGER NOT NULL, hold INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (effect_key, step))",
            "CREATE TABLE effect_step_fade (effect_key INTEGER REFERENCES effects (key) ON DELETE CASCADE NOT NULL, step INTEGER NOT NULL, fade INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (effect_key, step))",
            "CREATE TABLE effect_fixture_phase (effect_key INTEGER REFERENCES effects (key) ON DELETE CASCADE NOT NULL, fixture_key INTEGER REFERENCES fixtures (key) ON DELETE CASCADE NOT NULL, phase REAL DEFAULT 0 NOT NULL, PRIMARY KEY (effect_key, fixture_key))",
