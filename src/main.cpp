...
int main(int argc, char *argv[]) {
    ...
    const QStringList createTableQueries = {
        ...
        "CREATE TABLE IF NOT EXISTS models (key INTEGER, id TEST UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', channels TEXT DEFAULT 'D' NOT NULL, panrange REAL DEFAULT 540 NOT NULL, tiltrange REAL DEFAULT 270 NOT NULL, minzoom REAL DEFAULT 5 NOT NULL, maxzoom REAL DEFAULT 60 NOT NULL, PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS fixtures (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', model_key INTEGER REFERENCES models (key) ON DELETE SET NULL, universe INTEGER DEFAULT 1 NOT NULL, address INTEGER DEFAULT 0 NOT NULL, rotation REAL DEFAULT 0 NOT NULL, invertpan INTEGER DEFAULT 1 NOT NULL, PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS groups (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS intensities (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', dimmer REAL DEFAULT 0 NOT NULL, PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS colors (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', hue REAL DEFAULT 0 NOT NULL, saturation REAL DEFAULT 0 NOT NULL, quality REAL DEFAULT 100 NOT NULL, PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS positions (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', pan REAL DEFAULT 0 NOT NULL, tilt REAL DEFAULT 0 NOT NULL, zoom REAL DEFAULT 15 NOT NULL, PRIMARY KEY (key))",
        ...
        "CREATE TABLE IF NOT EXISTS raws (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS effects (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', steps INTEGER DEFAULT 2 NOT NULL, PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS cuelists (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', priority INTEGER DEFAULT 100 NOT NULL, movewhiledark INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (key))",
        "CREATE TABLE IF NOT EXISTS cues (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER UNIQUE NOT NULL, label TEXT DEFAULT '', PRIMARY KEY (key))",
