...
int main(int argc, char *argv[]) {
    ...
    if (fileExists) {
        ...
        const QStringList createTableQueries = {
            ...
            "CREATE TABLE cues (key INTEGER, id TEXT UNIQUE NOT NULL, sortkey INTEGER NOT NULL, cuelist_key INTEGER REFERENCES cuelists (key) ON DELETE CASCADE NOT NULL, label TEXT DEFAULT '', PRIMARY KEY (key))",
